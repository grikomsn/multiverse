...
description: An adventure log on discovering the secrets of the getInitialProps function and its mysterious object properties — updated March 2020
date: 2018-11-26
---
...
> _What damn are_ and _where are coming from_ the following properties of the context parameter?
...
![App context object properties](/images/app-context-object-properties.png)

![Page context object properties](/images/page-context-object-properties.png)
...
![Preview on control or command clicking the object type](/images/control-click.gif)
...
[_This was originally posted at Medium on November 26th, 2018 with the same title and contents._](https://medium.com/@griko/exploring-undocumented-getinitialprops-properties-on-next-js-1265a6abc652)
